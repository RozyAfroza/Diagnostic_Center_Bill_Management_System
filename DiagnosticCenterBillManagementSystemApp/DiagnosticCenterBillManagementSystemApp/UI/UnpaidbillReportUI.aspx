<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnpaidbillReportUI.aspx.cs" Inherits="DiagnosticCenterBillManagementSystemApp.UI.UnpaidbillReportUI" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="testwiseReportGridView" runat="server" AutoGenerateColumns="False" Width="734px">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Contact No">
                        <ItemTemplate>
                            <asp:Label runat="server"><%#Eval("MobileNo") %></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Patient TestName">
                        <ItemTemplate>
                            <asp:Label runat="server"><%#Eval("PatientTestName") %></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Bill Amount">
                        <ItemTemplate>
                            <asp:Label runat="server"><%#Eval("Amount") %></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
       ...
       <td class="auto-style3">  Total</td>
            <td> <asp:TextBox ID="totalTextBox" runat="server" Width="183px"></asp:TextBox></td>
        </tr></table>
        </asp:Panel>
    </div>
    </form>
